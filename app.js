...
app.get("/players/", async (request, response) => {
  //Promise object with async and await
...
//Update player Details using name and Id of the player
app.put("/players/:playerId", async (request, response) => {
  const { playerId } = request.params; //to get the parameters of playerID object
...
// Get details of match using match ID
...
//get player Details using playerId
...
//Get Players score using player Id
